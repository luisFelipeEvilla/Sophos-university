...
export default function addProfessor() {
    ...
    const onSubmit: SubmitHandler<Inputs> = async data => {
        ...
        if (res.status === 200) {
            ...
            toast('Error adding student', { icon: '❌' })
            console.log(res);
        }
    }
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="flex w-full justify-center">
            <div className="flex flex-col items-center w-3/5 my-10">
                <CreateBanner title="Add New Student" imgPath={"/images/create-student-banner"} />
                ...
                <div className="flex flex-col mt-4">
                    ...
                    <SelectInput rows={faculties} rowsLabel="name" rowsValue="id" label="Faculty" placeholder="faculty" register={register} fieldName="facultyId" options={{ required: { value: true, message: "Select a valid faculty is required" }, valueAsNumber: true }} errors={errors} />
                </div>
